...
ChatClient.prototype = {
    ...
    init: function () {
        ...
        // 表格解析工具
        let extractTableClient=new ExtractTableClient(map,svc)
        extractTableClient.addExtractTableButton()
        this.extractTableClient = extractTableClient
