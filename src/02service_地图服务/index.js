        ...
        function newMap(res) {
            ...
            map.enableLayerClickHighlight(svc, e => {
                ...
                if (one==null){
                    ...
                    two=e
                    let oneBounds=map.getEnvelopBounds(one.envelop)
                    let twoBounds=map.getEnvelopBounds(two.envelop)
                    let distance=getMinDistance(oneBounds,twoBounds)
                    console.log("两者之间的距离为：",distance)
                    two=null
                    one=null
                }
            ...
            chatUtils=new ChatClient(map,svc)
            chatUtils.init()
        }
